...
- 2026-09-25 MAS 對 801516 最新回信表示將審查舊案前保險桿估價，並依現有資料暫不納入左前葉子板；同日 9/22 BMW 新案仍分開處理。舊案回覆只確認繼續審查前保險桿估價，不提估價單中其他工項的技術必要性，不授權施工、不先決定自車是否維修；待審查結果及金額後再決定。新舊案不混寫。
...
- 2026-09-26 已依使用者明確要求，將佳蓉利益置於舊案保險溝通的首要原則，同時確保陳述真實、可核實，並完整回答保險公司明確詢問或核賠所需的重大事實。對 801516，MAS 9/25 信表示會繼續審查前保險桿估價並依現有資料暫不納入左前葉子板；建議回信只確認繼續審查前保險桿估價，索取書面結果／評估金額／後續步驟，明示同意審查不等於授權維修或接受最終理賠範圍，收到結果後再決定是否修自車。不主動帶入與本次確認無關的其他估價工項，也不問 MAS 車廠的技術工法或維修必要性；若 MAS 明確詢問或審查需要，依事實完整回覆。Rosiez 解釋估價項目、工法及技術必要性；MAS 說明理賠範圍、審查金額、自負額及流程。舊案信只談 801516，不提 9/22 新案。MAS 8/17 舊案自負額條件保持個案範圍：修自車只收一次 NZD 500；只處理第三方責任或維修不具經濟效益改按 liability only 時不收自負額；評估費由 MAS 負擔。
