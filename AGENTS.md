...
- 2026-09-25 MAS 新案 Section 5「Review and submit」核對：`Were other vehicles involved?` 問的是受保車以外有無其他車輛參與；只有受保車與一台對方車時仍選 Yes，只有沒有其他車輛時才選 No。使用者提供的審核頁目前顯示 No，需改 Yes；事故敘述亦有重複段落，應先清空欄位、一次貼入處理卡單一完整版本，回摘要檢查無重複，再確認聲明真實後送出。截圖所示其他欄位為駕駛 Me、駕照 Overseas／1 year；酒精、drugs、DUI 檢測及前科皆選 No，但每項須逐項核實；`Had you taken any medication?` 亦顯示 No，但問的是有無服用藥品，不是是否違規，若有服用須如實選 Yes。審核頁不等於已申報，未見 MAS 確認頁前不得標記為已送出。
