...
- 2026-09-17 Rosiez已確認照片不足以準確估價，必須到現場檢查車輛並請佳蓉提供日期與時間。佳蓉每週六才取得下一週班表；停車事故卡應先提供iOS文字訊息告知排班規則，再於週六提供具體時段，並持續限定只授權評估與估價、不授權維修。Frikkie可用紐西蘭手機號碼傳送文字訊息，完整號碼僅留在獨立事故卡，不擴散至主手冊或AGENTS.md。
