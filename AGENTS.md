...
- 2026-08-14 MAS已明確提供本案正式案件編號、自負額及選擇維修廠的下一步，並要求維修前先交估價與照片取得核准。教戰卡應優先請MAS推薦基督城認可維修廠，只安排檢查／估價、不先授權開工；若考慮不修自車，第三方求償持續時自負額如何收取須向MAS取得書面確認。照片只能支持「無明顯立即停駛跡象」，不能取代固定座、裂痕及安全性的實車檢查。
