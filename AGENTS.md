...
- 2026-09-26 MAS Assessing 於 9/25 12:45 就舊案 801516 詢問是否繼續審查前保險桿估價；此請求是估價審查與提供費用，不是維修授權。回覆不必等待 9/22 新案正式案號，且舊案信不提新事故；同意範圍限估價審查、不授權施工，說明舊案自車不修、第三方責任仍請 MAS 處理，並確認估價審查費用與先前不收自負額安排是否仍適用。建議由 Chia-Jung 信箱另寄 `claims@mas.co.nz`，副本 `assessors@mas.co.nz`，主旨含 `801516`；寄出前後均不可把建議稿標為已寄。
