...
- MAS投保報價只列`Full Licence / Issued by Other`，未列駕照持有年數；MAS後續書面確認已把有效保單的海外／國際駕照資料更正。公開理賠表單的可選類型為Full、Restricted、Learner、Overseas，沒有International；理賠表應選Overseas，年數欄依首次取得日如實填寫，不可猜測。留存的早期MV971912 PDF曾誤列New Zealand，不能作為更正後駕照資料的依據。
