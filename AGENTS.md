...
- 已簽發的MAS報價／Schedule只列`Full Licence / Issued by Other`，不顯示駕照持有年數；但MAS公開投保申請表與理賠表均詢問Years held，不能據Schedule空白推論投保時未收集。MAS後續書面確認已把有效保單的海外／國際駕照資料更正。公開理賠表單的可選類型為Full、Restricted、Learner、Overseas，沒有International；理賠表應選Overseas，年數欄依首次取得日如實填寫，不可猜測。現行Schedule額外自負額未列持照年數項目。留存的早期MV971912 PDF曾誤列New Zealand，不能作為更正後駕照資料的依據。
