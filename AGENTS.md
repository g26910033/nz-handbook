...
- MAS Schedule以`International Licence / Issued by Other`記錄佳蓉駕照，但公開理賠表單的可選類型為Full、Restricted、Learner、Overseas，沒有International；理賠表應選Overseas並如實填首次取得駕照後的完成年數，不可為迎合保單文字改填不存在選項或猜測年數。
