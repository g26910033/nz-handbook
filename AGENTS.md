...
- 目前 Mastercard 匯率來源：`https://www.mastercard.com.cn/zh-cn/personal/get-support/convert-currency.html`；本輪官方直連被 Akamai 403 阻擋時，以 SG Rates MasterCard 同日 `NZD`/`MYR`/`USD`/`TWD` 對 `SGD` 交叉換算。
- 目前 Mastercard 匯率基準：`07/11`
  - `1 NZD = 18.5790 TWD`
  - `1 MYR = 7.8952772 TWD`
  - `1 USD = 32.0548251 TWD`
- 目前財務摘要：
  - 已支出：`TWD 118,042`
  - 待支出：`TWD 160,475`
  - 總預估：`TWD 278,517`
...
- 2026-07-08 Gmail確認回程改為律德Jetstar JQ226 2026-08-02 06:15 CHC → 07:35 AKL；08/01 Airport Westney Lodge 2 已由Agoda免費取消，退款/取消費NZD0.00；改票費NZD6.09已列入已支出交通。
...
- 2026-07-12 Gmail確認Mossburn Railway Hotel（07/24）已免費取消；同日改訂Kingston TOP 10 Holiday Park標準小屋，已付NZD91.76（含NZD1.76信用卡附加費）／實刷TWD1,714，入住前72小時以上取消可退75%。公開手冊不放訂房編號、地址或聯絡方式。
- 2026-07-14 Gmail確認兩筆Hanmer Springs Thermal Pools票券已改為07/17 10:00；07/16 09:30安排獨立驗車，僅在無重大問題後辦理過戶並線上投保State。State目前僅有年度綜合車險報價NZD896.24，尚非已生效保單；公開手冊不得放車牌、報價號、保單號、VIN、賣方資訊或地址。
