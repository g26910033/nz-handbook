...
- 目前匯率基準：Mastercard `08/10`、永豐 `08/11 15:30`
  - `1 NZD = 19.0331841 TWD`
  - `1 USD = 32.2159667 TWD`
  - `1 JPY = 0.2045 TWD`
- 目前財務摘要：
  - 已支出：`TWD 294,989`
  - 待支出：`TWD 15,266`
...
- 財務總控表採「總額、待辦與可用預算、已支出分類、可展開帳單核對」四層結構；日常畫面保持精簡，正式帳單逐筆資料由財務與住宿各自責任區保留，列印時必須完整顯示。
