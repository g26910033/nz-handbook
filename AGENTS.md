...
- 2026-09-17 Rosiez已確認照片不足以準確估價，必須到現場檢查車輛並請佳蓉提供日期與時間。使用者更正操作分工：iOS訊息由使用者在自己的電腦傳給佳蓉；佳蓉每週六取得下一週班表後，仍以原Email信串回覆Rosiez。停車事故卡不得引導佳蓉用iOS訊息聯絡Rosiez；訊息按鈕只作使用者傳給佳蓉的內部提醒，並持續限定只授權評估與估價、不授權維修。完整私人電話僅留在獨立事故卡，不擴散至主手冊或AGENTS.md。
